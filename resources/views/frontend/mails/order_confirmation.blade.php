...
<body class="body" id="body" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" bgcolor="#ecba78"
  ...
  <div
    ...
    Chúng tôi đã nhận được đơn đặt hàng của bạn. Chúng tôi sẽ gửi cho bạn một email khác khi đơn đặt hàng của bạn được giao.
  </div>
  <!--<![endif]-->
  <!-- BEGIN: CONTAINER -->
                              ...
                              <tbody>
                                ...
                                <tr id="section-1468267" class="section introduction">
                                  <th style="mso-line-height-rule: exactly; padding: 13px 52px;" bgcolor="#ffffff">
                                    ...
                                    <p style="mso-line-height-rule: exactly; font-family: -apple-system,BlinkMacSystemFont,'Segoe UI',Arial,'Karla'; font-size: 16px; line-height: 26px; font-weight: 400; color: #666363; margin: 13px 0;"
                                      align="center">Chúng tôi đã nhận được đơn đặt hàng của bạn. Cảm ơn vì đã tin tưởng và ủng hộ {{config('app.name')}}.</p>
                                    <p style="mso-line-height-rule: exactly; font-family: -apple-system,BlinkMacSystemFont,'Segoe UI',Arial,'Karla'; font-size: 16px; line-height: 26px; font-weight: 400; color: #666363; margin: 13px 0;"
                                      align="center">Chúng tôi sẽ gửi cho bạn một email khác khi đơn đặt hàng của bạn được giao.</p>
                                  </th>
                                </tr>
                                                      ...
                                                      <tbody>
                                                        <tr>
                                                          ...
                                                          <th class="right line-item-line-price" width="1"
                                                            ...
                                                            <p style="mso-line-height-rule: exactly; font-family: -apple-system,BlinkMacSystemFont,'Segoe UI',Arial,'Karla'; font-size: 16px; line-height: 26px; font-weight: 400; color: #666363; margin: 0;"
                                                              align="right">
                                                              {{convertPrice($product->pivot->price, ' VNĐ')}}
                                                            </p>
                                                          </th>
                                                        </tr>
                                                      </tbody>
                                              ...
                                              <tbody>
                                                ...
                                                <tr>
                                                  <th class="table-title" data-key="1468271_subtotal"
                                                    ...
                                                    align="left" bgcolor="#ffffff" valign="top">Cộng tiền</th>
                                                  <th class="table-text"
                                                    ...
                                                    {{convertPrice($order->total_price, ' VNĐ')}}</th>
                                                </tr>
                                                <tr>
                                                  <!-- Discount -->
                                                  <th class="table-title"
                                                    ...
                                                    <span data-key="1468271_discount"
                                                      style="font-weight: bold;">Giảm giá</span> (0%)
                                                  </th>
                                                  <th class="table-text"
                                                    style="mso-line-height-rule: exactly; font-family: -apple-system,BlinkMacSystemFont,'Segoe UI',Arial,'Karla'; font-size: 16px; line-height: 26px; font-weight: 400; color: #666363; width: 35%; padding: 6px 0;"
                                                    align="right" bgcolor="#ffffff" valign="middle">- 0 VNĐ</th>
                                                  <!-- End Discount -->
                                                </tr>
                                                ...
                                                <tr>
                                                  <th class="table-title"
                                                    style="mso-line-height-rule: exactly; font-family: -apple-system,BlinkMacSystemFont,'Segoe UI',Arial,'Karla'; font-size: 16px; line-height: 26px; font-weight: bold; color: #666363; width: 65%; padding: 6px 0;"
                                                    align="left" bgcolor="#ffffff" valign="top">Phí giao hàng
                                                  </th>
                                                  <th class="table-text"
                                                    style="mso-line-height-rule: exactly; font-family: -apple-system,BlinkMacSystemFont,'Segoe UI',Arial,'Karla'; font-size: 16px; line-height: 26px; font-weight: 400; color: #666363; width: 35%; padding: 6px 0;"
                                                    align="right" bgcolor="#ffffff" valign="middle">0 VNĐ</th>
                                                ...
                                                <tr class="pricing-table-total-row">
                                                  <th class="table-title" data-key="1468271_total"
                                                    style="mso-line-height-rule: exactly; font-family: -apple-system,BlinkMacSystemFont,'Segoe UI',Arial,'Karla'; font-size: 16px; line-height: 26px; font-weight: bold; color: #666363; width: 65%; padding: 6px 0;"
                                                    align="left" bgcolor="#ffffff" valign="top">Tổng tiền thanh toán</th>
                                                  <th class="table-text"
                                                    style="mso-line-height-rule: exactly; font-family: -apple-system,BlinkMacSystemFont,'Segoe UI',Arial,'Karla'; font-size: 16px; line-height: 26px; font-weight: 400; color: #666363; width: 35%; padding: 6px 0;"
                                                    align="right" bgcolor="#ffffff" valign="middle">
                                                    {{convertPrice($order->total_price*(1-0/100), ' VNĐ')}}</th>
                                                </tr>
                                                <!-- End Total Price -->
                                                ...
                                                <tr>
                                                  <th style="mso-line-height-rule: exactly; padding-right: 5%;"
                                                    ...
                                                    <h3 data-key="1468273_bill_to"
                                                      ...
                                                      align="left">Thông tin giao hàng</h3>
                                                  </th>
                                                </tr>
                                                <tr>
                                              ...
                                              <tbody>
                                                <tr>
                                                  <th style="mso-line-height-rule: exactly; padding-left: 5%;"
                                                    ...
                                                    <h3 data-key="1468273_ship_to"
                                                      style="font-family: -apple-system,BlinkMacSystemFont,'Segoe UI',Arial,'Karla'; color: #bdbdbd; font-size: 16px; line-height: 52px; font-weight: 700; text-transform: uppercase; letter-spacing: 1px; margin: 0;"
                                                      align="right">Phương thức thanh toán</h3>
                                                  </th>
                                                </tr>
                                                ...
                                                <tr>
                                                  <th class="shipping_address "
                                                    ...
                                                    align="right" bgcolor="#ffffff" valign="top">
                                                    <p style="mso-line-height-rule: exactly; font-family: -apple-system,BlinkMacSystemFont,'Segoe UI',Arial,'Karla'; font-size: 16px; line-height: 26px; font-weight: 400; color: #666363; margin: 0;"
                                                      align="right">{{$order->payment == 'cod' ? 'Thanh toán khi nhận hàng' : 'Ví ' . strtoupper($order->payment) }}
                                                    </p>
                                                  </th>
                                                </tr>
                                              </tbody>
                                ...
                                <tr id="section-1468276" class="section closing_text">
                                  <th data-key="1468276_closing_text" class="text"
                                    ...
                                    align="center" bgcolor="#ffffff">
                                    <p style="mso-line-height-rule: exactly; font-family: -apple-system,BlinkMacSystemFont,'Segoe UI',Arial,'Karla'; font-size: 16px; line-height: 26px; font-weight: 400; color: #666363; margin: 0;"
                                      align="center">Nếu bạn cần trợ giúp về bất cứ điều gì xin vui lòng gửi email cho chúng tôi
                                      email: {{config('mail.from.address')}}</p>
                                  </th>
                                </tr>
                                      ...
                                      <tbody>
                                        <tr>
                                          <th class="column_shop_block1 " width="100%"
                                            ...
                                            align="center" bgcolor="#ffffff">
                                            <a href="#" target="_blank" data-key="section_shop_block1"
                                              style="color: #ecba78; text-decoration: none !important; text-underline: none; font-size: 14px; font-weight: 400; text-transform: none;">{{config('app.url')}}</a>
                                          </th>
                                        </tr>
                                        <!-- Store Website : END -->
                                      </tbody>
